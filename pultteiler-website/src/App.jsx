...
function Versand({ go }) {
  ...
  const infoBox = (icon, title, lines) => (
    <div style={{ background: C.bgElevated, border: `1px solid ${C.border}`, padding: "24px 28px", display: "flex", gap: 20, alignItems: "flex-start", marginBottom: 2 }}>
      <div style={{ width: 40, height: 40, background: `${C.accent}15`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, color: C.accent, fontSize: 20 }}>{icon}</div>
      <div>
        <div style={{ fontFamily: "'Inter Tight', sans-serif", fontSize: 11, fontWeight: 700, letterSpacing: "0.14em", color: C.accent, marginBottom: 6 }}>{title}</div>
        {lines.map((l, i) => <div key={i} style={{ fontFamily: "'Inter Tight', sans-serif", fontSize: 14, color: C.text, lineHeight: 1.65 }}>{l}</div>)}
      </div>
    </div>
  );
      ...
      <section style={{ padding: "80px 32px 96px", background: C.bg }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 2, marginBottom: 2 }}>
              {[
                ...
                <Reveal key={i} delay={i * 0.06}>
                  <div style={{ background: C.bgCard, border: `1px solid ${C.border}`, padding: "28px 24px", textAlign: "center", transition: "border-color 0.3s" }} onMouseEnter={e => e.currentTarget.style.borderColor = C.accent} onMouseLeave={e => e.currentTarget.style.borderColor = C.border}>
          ...
          <div style={{ background: C.bgCard, border: `1px solid ${C.border}`, padding: "48px 40px", marginTop: 2 }}>
            ...
            <p style={s}>
              Wir versenden alle Bestellungen direkt ab Werk in Altmünster am Traunsee. Der Versand erfolgt mit einem zuverlässigen Paketdienstleister. Nach Eingang und Bearbeitung Ihrer Bestellung erhalten Sie eine Bestätigungs-E-Mail.
            </p>

            <h2 style={h}>2. LIEFERZEITEN</h2>
            <p style={s}>
              Die Lieferzeit beträgt in der Regel <strong>5–10 Werktage</strong> ab Auftragsbestätigung. Für Lieferungen in die Schweiz kann die Lieferzeit geringfügig länger ausfallen. Bei Lieferverzögerungen werden Sie von uns unverzüglich informiert. Für dringende Bestellungen stehen wir gerne per E-Mail oder Telefon zur Verfügung.
            </p>
            ...
            <p style={{ ...s, marginTop: 12 }}>
              Die jeweils gültigen Versandkosten werden vor Abschluss der Bestellung im Warenkorb angezeigt.
            </p>

            <h2 style={h}>4. LIEFERUNG IN DIE SCHWEIZ</h2>
            <p style={s}>
              Lieferungen in die Schweiz erfolgen <strong>steuerfrei und unverzollt</strong>. Der im Shop ausgewiesene Preis ist der Endpreis — es fallen für Sie keine zusätzlichen Zollgebühren oder Einfuhrsteuern an. Die Abwicklung mit dem Schweizer Zoll übernehmen wir vollständig.
            </p>

            <h2 style={h}>5. STEUERFREIE LIEFERUNG NACH DEUTSCHLAND</h2>
            <p style={s}>
              Unternehmen und Institutionen in Deutschland können bei Angabe einer gültigen deutschen UID-Nummer eine steuerfreie innergemeinschaftliche Lieferung in Anspruch nehmen. Bitte tragen Sie Ihre UID-Nummer bei der Bestellung ein. Wir führen die erforderliche Zusammenfassende Meldung durch. Ein deutsches Bankkonto für die Zahlung ist vorhanden.
            </p>

            <h2 style={h}>6. E-RECHNUNG FÜR ÖSTERREICHISCHE BUNDESSCHULEN</h2>
            <p style={s}>
              Für Schulen des Bundes in Österreich stellen wir E-Rechnungen aus. Bitte geben Sie Ihre EKG-Nummer (Einkäufergemeinschaft) im Bestellformular an. Wir kümmern uns um die korrekte Ausstellung und elektronische Übermittlung der Rechnung.
            </p>

            <h2 style={h}>7. WIDERRUFSRECHT & RÜCKGABE</h2>
            <p style={s}>
              Verbraucher im Sinne des Konsumentenschutzgesetzes haben das Recht, den Vertrag innerhalb von <strong>14 Tagen ohne Angabe von Gründen zu widerrufen</strong> (§ 11 FAGG). Die Frist beginnt mit dem Tag, an dem Sie oder ein von Ihnen benannter Dritter die Ware in Empfang genommen hat.
            </p>
            <p style={s}>
              Um Ihr Widerrufsrecht auszuüben, informieren Sie uns bitte per E-Mail an <a href="mailto:blaschegg@traunseenet.at" style={{ color: C.accent, textDecoration: "none" }}>blaschegg@traunseenet.at</a> oder per Post an: Schulmittel Blaschegg, Stücklbachstraße 13, 4813 Altmünster, Österreich. Eine eindeutige Erklärung über Ihren Entschluss zum Widerruf genügt.
            </p>

            <h2 style={h}>8. RÜCKSENDUNG</h2>
            <p style={s}>
              Nach Ausübung des Widerrufsrechts senden Sie die Ware bitte unverzüglich und spätestens innerhalb von <strong>14 Tagen</strong> an unsere Adresse zurück:
            </p>
            <div style={{ background: C.bgElevated, border: `1px solid ${C.border}`, padding: "20px 24px", marginBottom: 20 }}>
              <p style={{ ...s, margin: 0 }}>
                <strong>Schulmittel Blaschegg</strong><br/>
            ...
            <p style={s}>
              Die unmittelbaren Kosten der Rücksendung trägt der Käufer. Bitte verpacken Sie die Ware sorgfältig und verwenden Sie nach Möglichkeit die Originalverpackung. Wir empfehlen die Rücksendung per <strong>Hermes</strong> — die Kosten betragen ca. <strong>€ 6,50</strong> und der Versand erfolgt mit Sendungsverfolgung.
            </p>

            <h2 style={h}>9. RÜCKERSTATTUNG</h2>
            <p style={s}>
              Nach Eingang des wirksamen Widerrufs erstatten wir den Kaufpreis unverzüglich, spätestens jedoch <strong>binnen 14 Tagen</strong>. Wir können die Rückzahlung bis zum Eingang der zurückgesendeten Ware — oder bis Sie den Nachweis der Absendung erbracht haben — zurückhalten. Die Rückerstattung erfolgt über dasselbe Zahlungsmittel, das bei der ursprünglichen Transaktion verwendet wurde, sofern nicht ausdrücklich etwas anderes vereinbart wurde.
            </p>

            <h2 style={h}>10. ZUSTAND DER RÜCKGESENDETEN WARE</h2>
            <p style={s}>
              Sie sind nur für einen etwaigen Wertverlust der Ware verantwortlich, der auf einen zur Prüfung der Beschaffenheit, Eigenschaften und Funktionsweise der Ware nicht notwendigen Umgang zurückzuführen ist. Die Ware sollte möglichst im unbeschädigten Originalzustand zurückgesendet werden.
            </p>

            <h2 style={h}>11. AUSNAHMEN VOM WIDERRUFSRECHT</h2>
            <p style={{ ...s, marginBottom: 0 }}>
              Das Widerrufsrecht gilt nicht für Waren, die nach Kundenspezifikation individuell angefertigt wurden oder eindeutig auf persönliche Bedürfnisse zugeschnitten sind. Für Fragen zur Rückgabe stehen wir Ihnen jederzeit unter <a href="mailto:blaschegg@traunseenet.at" style={{ color: C.accent, textDecoration: "none" }}>blaschegg@traunseenet.at</a> zur Verfügung.
            </p>
          ...
          <Reveal delay={0.2}>
            <div style={{ marginTop: 32, display: "flex", gap: 16, flexWrap: "wrap" }}>
              ...
              <Btn onClick={() => go("kontakt")} variant="secondary">FRAGEN? KONTAKT →</Btn>
            </div>
          </Reveal>
        </div>
      </section>
...
export default function App() {
  ...
  useEffect(() => {
    const titles = { home: "Pultteiler — Der bewährte Sichtschutz für Schultische", produkte: "Produkte & Preise — Pultteiler", anleitung: "So funktioniert's — Pultteiler", galerie: "Referenzen — Pultteiler", "ueber-uns": "Über uns — Pultteiler", versand: "Versand & Rückgabe — Pultteiler", kontakt: "Kontakt — Pultteiler", impressum: "Impressum — Pultteiler", agb: "AGB — Pultteiler", datenschutz: "Datenschutz — Pultteiler" };
